...
function VerifyRequest(props) {
    ...
    return ( <
        ...
        variant = "outlined"
        sx = {
            { width: isActive ? "90%" : "20%", alignSelf: 'center' } }
        value = { captchaVal }
        onChange = {
            (e) => handleCaptchaChange(e) } >
        < /TextField> <
        br / >
        <
        ...
        href = '../reqs'
        sx = {
            { borderRadius: 28, alignSelf: 'center', justifySelf: 'center', textAlign: 'center' } } >
        Go Back <
        /Button> <
        Button variant = "contained"
        style = {
