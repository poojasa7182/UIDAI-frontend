...
function Request(props) {
  ...
  return (
    <Container className={classes.containerReq} sx={{ height: !isActive ? "90vh" : "auto" }}>
        ...
        <br></br>
        {!isActive?(<br></br>):('')}
        <Container className={classes.innerContainer} sx={{flexDirection: isActive ? 'column-reverse':''}}  >
            <Box className={classes.box1} sx={{width: isActive ? '100%' : '50%'}}>
                    ...
                    <Button
                        variant="contained"
                        style={{ backgroundColor: "#D32828" , maxWidth:'75%', padding:'1.5% 3%'}}
                        type="submit"
            ...
            <Box className={classes.box2} sx={{width: isActive ? '100%' : '50%', padding:isActive ? '2%' : '1%'}}>
                <br></br>
                    <Typography
                        variant="p"
                        sx={{
